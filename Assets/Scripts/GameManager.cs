...
public class GameManager : MonoBehaviour
{
    ...
    public class GM_Tree {
        ...
        // Constructor
        public GM_Tree(string _terrainName, int _treeINDEX, float _respawnTime, Transform _marker) {
    ...
    public List<GM_Tree> managedTrees = new List<GM_Tree>();
    ...
    public void AddTerrainTree(string _terrainName, int _treeIDX, float _respawnTime, Transform _marker) {
        ...
        managedTrees.Add (new GM_Tree(_terrainName, _treeIDX, _respawnTime, _marker));
    }
}
